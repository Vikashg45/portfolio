...
export default function Navbar() {
    ...
    useEffect(() => {
        const handleScorll = () => {
            ...
            if (currentScrollY > lastScorllY.current) {
                setVisible(false);
            }
            else {
                setVisible(true);
            ...
            lastScorllY.current = currentScrollY;
        }

        window.addEventListener("scroll", handleScorll, { passive: true });
